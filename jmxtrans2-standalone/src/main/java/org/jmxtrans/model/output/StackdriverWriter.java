 ...
 * {@linkplain org.jmxtrans.model.OutputWriter}.
 * <p/>
...
public class StackdriverWriter extends BaseOutputWriter {
	 ...
	 * 
	 * @throws java.io.IOException if there is some problem generating the JSON, should be uncommon
	 */
			...
			if (values != null) {
				for (Entry<String, Object> entry : values.entrySet()) {
					if (NumberUtils.isNumeric(entry.getValue())) {
						...
						String typeName = org.jmxtrans.model.naming.StringUtils.cleanupStr(KeyUtils.getConcatedTypeNameValues(typeNames, metric.getTypeName()));
